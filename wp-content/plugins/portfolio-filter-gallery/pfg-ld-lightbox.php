			...
			if(isset($pf_gallery_settings['image-ids']) && count($pf_gallery_settings['image-ids']) > 0) {
				...
				foreach($pf_gallery_settings['image-ids'] as $attachment_id) {
					...
					if(!isset($filter_keys)) {
						...
						<a href="<?php echo $full[0]; ?>" class="pfg-lightbox-all pfg-lightbox-<?php echo $filter_keys2; ?>" data-lightbox="pfg-lightbox" data-title="<?php _e($title); ?>" title="<?php echo $title; ?>">
