...
<div id="buddypress">
	...
	<div class="row rk-wp-alum-single-page-title-row text-center">

		<header class="entry-header text-center">
			<?php the_title( '<h1 class="entry-title">', '</h1>' ); ?>
		</header><!-- .entry-header -->

	</div><!--row single-page-title-row-->
	...
	<?php else: ?>
		...
		<div class="row">
			...
			<div class="col rk-wp-alum-buddypress-dir-search-form-container">
	...
	<form action="" method="post" id="members-directory-form" class="dir-form">
		...
		<div class="row rk-wp-alum-buddypress-members-dir-nav-container-row">

			<div class="col rk-wp-alum-buddypress-members-dir-nav-container">
			...
			</div><!-- rk-wp-alum-buddypress-members-dir-nav-container -->
